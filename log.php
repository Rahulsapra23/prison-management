   ...
   <div class="outer_1">
	   ...
	   <div class="top">
	       <div class="inner_logo" onClick="window.location.href='front.php'"><img src="img/download (3).jpg" width="80px;"height="100px;"></img></div>
			  ...
			  <div class="menu" onClick="window.location.href='admin.php'">ADMIN LOGIN</div>
			  <div class="menu" onClick="window.location.href='jailer.php'">JAILOR LOGIN</div>
			  
	    </div> 
		   
  
    <strong> <span style="text-align:center; color:#0000FF; font-size:38px; font-family:'Monotype Corsiva';" ><p>Welcome to the login panel....!!!!</p></span></strong>
